...
public class adrapter extends RecyclerView.Adapter<adrapter.ViewHolder>  {
    ...
    Context con;
    int back;
    public adrapter(Context context, List<product> data,int back)
    {
        this.data = data;
        this.con = context;
        this.back = back;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        try {
            ...
            holder.cn.setBackgroundResource(back);
        ...
        holder.cn.setPadding(20,5,20,5);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            cn = itemView.findViewById(R.id.customlay);
